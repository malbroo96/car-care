        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 space-y-8">
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              At Car-Bliss, we are committed to protecting your privacy. This
          ...
          <section>
            ...
            <div className="space-y-3 ml-4">
              ...
              <div>
                ...
                <p className="text-gray-700 text-sm">
                  We may collect information about how you access and use our
          ...
          <section>
            ...
            <ul className="space-y-2 text-gray-700 ml-6">
              ...
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <span>
                  To send you updates about products and services (with your
                  consent)
                </span>
              </li>
              <li className="flex items-start">
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              Car-Bliss is a participant in the Amazon Associates Program, an
              ...
              Amazon.in. When you click on our product links and make a
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              Amazon. We are not responsible for the privacy practices or
