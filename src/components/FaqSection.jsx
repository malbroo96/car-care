export default function FaqSection({ title = "Frequently Asked Questions", faqs }) {
  return (
    <section
      className="mx-auto my-16 max-w-7xl px-4 sm:px-5"
      aria-labelledby="faq-heading"
    >
      <div className="max-w-3xl">
        <h2 id="faq-heading" className="mb-3 text-2xl font-bold tracking-tight text-slate-900 md:text-3xl">
          {title}
        </h2>
      ...
      <div className="grid max-w-3xl gap-3">
        {faqs.map((faq) => (
          ...
          >
            <summary className="flex cursor-pointer list-none items-center justify-between gap-3 rounded-xl px-4 py-4 font-semibold text-slate-900 marker:content-none [&::-webkit-details-marker]:hidden">
